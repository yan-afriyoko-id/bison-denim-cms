      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="handleSubmit">
          <div class="modal-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label for="create_user_name" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_last_name" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_email" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_phone" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_dob" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_gender" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_role" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_password" class="form-label fw-medium">
              ...
              <div class="col-md-6">
                <label for="create_user_password_confirmation" class="form-label fw-medium">
...
const { createUser, getAllRoles } = useUserManagementApi()
const toast = useToast()

const form = reactive<UserCreatePayload & { role: string }>({
  name: '',
  last_name: '',
  email: '',
  phone: '',
...
const handleSubmit = async () => {
  ...
  if (error) {
    message.value = error.message || 'Failed to create user'
    messageType.value = 'error'
